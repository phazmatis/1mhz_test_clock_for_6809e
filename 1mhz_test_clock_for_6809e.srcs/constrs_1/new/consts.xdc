...
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { RW }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { E }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { Q }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { RESET }]; #IO_L6P_T0_15 Sch=ja[4]
...
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { A[7] }]; #IO_L11P_T1_SRCC_15 Sch=ja[10]


##Pmod Header JB

set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { D[0] }]; #IO_L12P_T1_MRCC_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { D[1] }]; #IO_L12N_T1_MRCC_15 Sch=jb[2]
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { D[2] }]; #IO_L22N_T3_A16_15 Sch=jb[3]
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { D[3] }]; #IO_L23P_T3_FOE_B_15 Sch=jb[4]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { D[4] }]; #IO_L23N_T3_FWE_B_15 Sch=jb[7]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { D[5] }]; #IO_L24P_T3_RS1_15 Sch=jb[8]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { D[6] }]; #IO_L24N_T3_RS0_15 Sch=jb[9]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { D[7] }]; #IO_25_15 Sch=jb[10]


##Pmod Header JC

set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { A[8] }]; #IO_L20P_T3_A08_D24_14 Sch=jc[1]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { A[9] }]; #IO_L20N_T3_A07_D23_14 Sch=jc[2]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { A[10] }]; #IO_L21P_T3_DQS_14 Sch=jc[3]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { A[11] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc[4]
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { A[12] }]; #IO_L22P_T3_A05_D21_14 Sch=jc[7]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { A[13] }]; #IO_L22N_T3_A04_D20_14 Sch=jc[8]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { A[14] }]; #IO_L23P_T3_A03_D19_14 Sch=jc[9]
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { A[15] }]; #IO_L23N_T3_A02_D18_14 Sch=jc[10]


##Pmod Header JD

set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { A[0] }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { A[1] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { A[2] }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { A[3] }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { A[4] }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { A[5] }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { A[6] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { A[7] }]; #IO_L15N_T2_DQS_35 Sch=jd[10]
